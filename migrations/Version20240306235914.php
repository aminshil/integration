 ...
 */
final class Version20240306235914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categorie_depot (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, publication_id INT DEFAULT NULL, demande_id INT DEFAULT NULL, commentpubdemuser_id INT DEFAULT NULL, comment LONGTEXT NOT NULL, dateofcom DATETIME NOT NULL, INDEX IDX_9474526C38B217A7 (publication_id), INDEX IDX_9474526C80E95E18 (demande_id), INDEX IDX_9474526C7C7794AF (commentpubdemuser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE depots (id INT AUTO_INCREMENT NOT NULL, categorie_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, etat VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_D99EA427BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526C7C7794AF FOREIGN KEY (commentpubdemuser_id) REFERENCES `user` (id)');
        ...
        $this->addSql('ALTER TABLE depots ADD CONSTRAINT FK_D99EA427BCF5E72D FOREIGN KEY (categorie_id) REFERENCES categorie_depot (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP FOREIGN KEY FK_9474526C7C7794AF');
        ...
        $this->addSql('ALTER TABLE depots DROP FOREIGN KEY FK_D99EA427BCF5E72D');
        ...
        $this->addSql('DROP TABLE categorie_depot');
