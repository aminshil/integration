...
class BadWordFilter
{
    ...
    public function filterBadWords(string $text): string
    {
        ...
        $badWords = ['shitup', 'shit', 'badword', 'Misérable', 'Pauvre', 'Nécessiteux', 'Affamé', 'Mendiant ', 'Sans-abri', 'Défavorisé', 'Démunis', 'Déshérité', 'SDF', 'À la rue', 'Crevard', 'Ruiné', 'Dépouillé', 'Démuni', 'Désargenté', 'Dépourvu ', 'Vulnérable', 'Pénurie' ];
